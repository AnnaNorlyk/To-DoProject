...
{ 
    public class TodoListService : ITodoListService
    {
        ...
        {
            // Check if the feature flag is defined and enabled
            if (!_fh.IsSet("enableListDeletion") || !_fh["enableListDeletion"].IsEnabled)
            {
                _logger.LogWarning("List deletion was disabled by feature toggle.");
                return false;
            }
